...
function guardar(){
	var cont = 0;
	var validar = false;
	var aCampos = [ "bonosAnio", "bonosMes", "diaVencimiento", "mesVencimiento", "jornadas", "nombreSolicitud","horarios","equivalenteBono"];
	var aTipos = [ "numds", "numds", "numds","numds", "multi","text","text","numds"];
